/** biome-ignore-all lint/nursery/noIncrementDecrement: Increment/decrement is acceptable for this test */
    ...
    describe("Real-world schemas", () => {
      ...
      test("parses search tool schema", () => {
        const schema = z.object({
          ...
          filters: z.array(z.string()).optional().describe("Filter categories"),
        });
